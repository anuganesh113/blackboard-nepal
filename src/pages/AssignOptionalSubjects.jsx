...
const AssignOptionalSubjects = () => {
  ...
  // Optional subjects available for selection
  const optionalSubjects = [
    { id: 'economics', name: 'Economics' },
    { id: 'optMaths', name: 'OPT Maths' }
  ];

  // Sample student data - All students with their batch, class, and section info
  const [allStudents, setAllStudents] = useState([
    { id: 1, rollNo: 12, name: 'Aayusma B.C', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 2, rollNo: 13, name: 'Anmol B.c', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 3, rollNo: 17, name: 'Avaya Ayer', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 4, rollNo: 2, name: 'Bipin Sharma', economics: false, optMaths: true, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 5, rollNo: 9, name: 'Diya Malla', economics: false, optMaths: true, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 6, rollNo: 15, name: 'Grishma Bogati', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'B' },
    { id: 7, rollNo: 16, name: 'Himansu Chunara', economics: false, optMaths: true, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 8, rollNo: 14, name: 'Nikita Khadka', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'B' },
    { id: 9, rollNo: 5, name: 'Nosika Thapa', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 10, rollNo: 1, name: 'Parson Bahadur Bohara', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 11, rollNo: 4, name: 'Rajendra Saud', economics: false, optMaths: false, batchId: 2, classId: 9, sectionId: 'A' },
    { id: 12, rollNo: 11, name: 'Rohit Dhami', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 13, rollNo: 3, name: 'Shusil Khadka', economics: false, optMaths: false, batchId: 2, classId: 9, sectionId: 'B' },
    { id: 14, rollNo: 10, name: 'Sishir B.k', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 15, rollNo: 7, name: 'Sumant Awasthi', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
    { id: 16, rollNo: 6, name: 'Supriya Awasthi', economics: false, optMaths: false, batchId: 2, classId: 9, sectionId: 'A' },
    { id: 17, rollNo: 8, name: 'Uday Chaudhary', economics: false, optMaths: false, batchId: 1, classId: 10, sectionId: 'A' },
  ]);
  ...
  ], [startIndex, optionalSubjects, handleCheckboxChange]);
...
export default AssignOptionalSubjects;
